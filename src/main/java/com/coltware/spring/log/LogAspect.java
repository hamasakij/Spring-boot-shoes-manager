...
public class LogAspect {
     ...
     */
    @After("execution(* com.coltware.spring.controller.*Controller.*(..))")
    public void doAfterController(){
        logger.debug("■■■■■■■■■■■■■■■　doAfter controller");
    }

    @AfterReturning(pointcut = "execution(* com.coltware.spring.controller.*Controller.*(..))", returning= "result")
    public void doAfterReturn(Object result){
        logger.debug("■■■■■■■■■■■■■■■　Result : {}", result);
    }

    @Before("execution(* com.coltware.spring.service.*ServiceImpl.*(..))")
